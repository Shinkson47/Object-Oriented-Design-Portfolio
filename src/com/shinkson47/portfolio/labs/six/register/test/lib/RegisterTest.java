package com.shinkson47.portfolio.labs.six.register.test.lib;
...
import com.shinkson47.portfolio.labs.six.register.lib.*;
...
public class RegisterTest {
	...
	public void testCountFirstNameOccurrences() {
		...
		assertEquals("First count should return 0", 0, r.countFirstNameOccurrences("Luke"));

		r = new Register();
		r.addName(new Name("Luke", "Bloggs"));
		r.addName(new Name("Jen", "Jones"));

		assertEquals("Second count should return 1", 1, r.countFirstNameOccurrences("Luke"));

		r = new Register();
		r.addName(new Name("Luke", "Bloggs"));
		r.addName(new Name("Luke", "Jones"));

		assertEquals("Third count should return 2", 2, r.countFirstNameOccurrences("Luke"));

		r = new Register();
		r.addName(new Name("Anna", "Bloggs"));
		r.addName(new Name("Fred", "Jones"));

		assertEquals("Fourth count should return 0", 0, r.countFirstNameOccurrences("TOM"));

		r = new Register();
		r.addName(new Name("Tom", "Bloggs"));
		r.addName(new Name("Jon", "Jones"));

		assertEquals("Fifth count should return 1", 1, r.countFirstNameOccurrences("TOM"));

		r = new Register();
		r.addName(new Name("Tom", "Bloggs"));
		r.addName(new Name("Tom", "Jones"));

		assertEquals("Sixth count should return 2", 2, r.countFirstNameOccurrences("TOM"));

		r = new Register();
		r.addName(new Name("Luke", "Bloggs"));
		r.addName(new Name("Jen", "Jones"));

		assertEquals("Seventh count should return 1", 1, r.countFirstNameOccurrences("LuKe"));
